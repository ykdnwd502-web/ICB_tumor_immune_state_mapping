...
out_table_dir <- file.path(project_dir, "results", "tables", "CosMx_spatial_LR_validation", "KNN10")
out_fig_dir   <- file.path(project_dir, "results", "figures", "CosMx_spatial_LR_validation", "KNN10")
...
# K10 sensitivity version: all output files include K10 to avoid overwriting K20/K30 results.
k_neighbors <- 10
