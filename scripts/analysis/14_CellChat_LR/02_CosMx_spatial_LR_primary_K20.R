...
out_table_dir <- file.path(project_dir, "results", "tables", "CosMx_spatial_LR_validation", "KNN20")
out_fig_dir   <- file.path(project_dir, "results", "figures", "CosMx_spatial_LR_validation", "KNN20")
...
build_knn_edges <- function(df, k = 10) {
