...
fig <- (pA | pB) / pC +
  patchwork::plot_annotation(
    tag_levels = "A",
    title = "Supplementary Figure S29. Patient-level structure of predefined tumor–immune states in GSE244983",
...
base <- file.path(FIG_DIR, "Supplementary_Figure_S29_patient_level_structure")
